    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.BooleanField(default=True)),
                ('Maquina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='spcmapp.maquina')),
                ('codigo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='spcmapp.cliente')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Cod_maquina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='spcmapp.maquina')),
            ],
        ),
        migrations.CreateModel(
            name='Reporte',
